...
% [preprint] hardcodes "Preprint. Under review." into the first-page footer.
% This is not under review anywhere, so the footer says what the document is.
\makeatletter
\renewcommand{\@noticestring}{Preprint. \today.}
\makeatother
